      ...
      <Grid container style={{ marginTop: 40 }}>
        <Grid item xs={12}>
          <Box
            ...
            boxShadow={2}
            borderRadius={10}
            borderColor="rgba(112, 109, 109, 0.712)"
          >
            <h3 style={{ margin: "5px" }}>
              {user
            ...
            <div className={classes.imgContainer}>
              ...
              {userData?.photoURL ? (
                <Avatar src={userData.photoURL} alt="profile" />
              ) : (
                <Input
                  className={classes.selectFileText}
                  hidden
                  multiple
                  required
                  accept="image/*"
              ...
              <label htmlFor="imageUpload">
                {""}
                {userData?.photoURL ? (
                  <AddAPhotoIcon style={{ display: "none" }} />
                ) : (
                  <AddAPhotoIcon
                    fontSize="small"
              ...
              <div className="row">
                          ...
                          <div key={index}>
                            <div className="col order-last">
                              ...
                              <IconButton
                                aria-label="delete"
                                onClick={() =>
                                  handleDelete(fav.userText, fav.timestamp)
                                }
                              >
                                <DeleteIcon />
                              </IconButton>
                ...
                <div className="col">
                  ...
                  >
                    <h5>Fav Episodes</h5>
                    {userData ? (
                      userData.favEpisodes.map((fav, index) => {
                        ...
                        return (
                          <div className="col order-last" key={index}>
                                ...
                                <div>
                                  <CardMedia className={classes.podcastImage}>
                                    <img
                                      ...
                                      src={fav.episodeThumbnail}
                                      alt="Podcast thumbnail"
                                    />
                                  </CardMedia>
                                  <IconButton
                                    className="btnEpisodes"
                                    aria-label="delete"
                                    onClick={() =>
                                      handleDeleteAudioFav(
                                        fav.audioFile,
                                        fav.episodeThumbnail,
                                        fav.episodeTitle,
                                        fav.timestamp
                                      )
                                    }
                ...
                <div className="col">
                  ...
                  >
                    <h5>Fav Podcast</h5>
                    {userData ? (
                      userData.favPodcast.map((fav, index) => {
                        return (
                          <div className="col order-last" key={index}>
                            <div>
                              <div>
                                ...
                                >
                                  <Link to={`/podcaslist/${fav.podcast.id}`}>
                                    {/* <p>{fav.podcast.title}</p> */}
                                    <img
                                      src={fav.podcast.thumbnail}
                                      alt="logo"
                                      style={{
                                        width: "120px",
                                        height: "120px",
