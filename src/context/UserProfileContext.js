...
export const UserProfileContextProvider = ({ children }) => {
  ...
  const deleteFavorite = (userText, timestamp) => {
    //REVIEW userText lo recibo del handleDelete del UserProfil...pero porque si no lllamo igual el argumen que el field mas abajo, no funciona?
    const userRef = db.collection("userProfile").doc(user.uid);
